...
const majorTab = document.querySelector('.aside__container > div:nth-child(4)');
...
const majorSection = document.querySelector('.right_content-item__wrapper:nth-child(4)');
...
profileTab.addEventListener('click', () => {
  ...
  majorTab.classList.remove('active-item');
  profileSection.style.display = 'block';
  studySection.style.display = 'none';
  codeSection.style.display = 'none';
  majorSection.style.display = 'none';
...
majorTab.addEventListener('click', () => {
  ...
  studyTab.classList.remove('active-item');
  codeTab.classList.remove('active-item');
  majorTab.classList.add('active-item');
  profileSection.style.display = 'none';
  studySection.style.display = 'none';
  codeSection.style.display = 'none';
