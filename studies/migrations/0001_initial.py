    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('어학', '어학'), ('컴퓨터', '컴퓨터'), ('기사 시험', '기사 시험'), ('공무원', '공무원'), ('임용', '임용'), ('취준', '취준'), ('전공공부', '전공공부'), ('코딩', '코딩'), ('대학원 진학', '대학원 진학'), ('자격증', '자격증'), ('기타', '기타'),], max_length=59)),
